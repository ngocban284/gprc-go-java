...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return protoInJava.StorageMessage.internal_static_techschool_pcbook_Storage_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return protoInJava.StorageMessage.internal_static_techschool_pcbook_Storage_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            protoInJava.Storage.class, protoInJava.Storage.Builder.class);
  }
  ...
  public enum Driver
    ...
    public static final com.google.protobuf.Descriptors.EnumDescriptor
        getDescriptor() {
      return protoInJava.Storage.getDescriptor().getEnumTypes().get(0);
    }
   ...
   * @return The driver.
   */
  @java.lang.Override public protoInJava.Storage.Driver getDriver() {
    @SuppressWarnings("deprecation")
    protoInJava.Storage.Driver result = protoInJava.Storage.Driver.valueOf(driver_);
    return result == null ? protoInJava.Storage.Driver.UNRECOGNIZED : result;
  }

  public static final int MEMORY_FIELD_NUMBER = 2;
  private protoInJava.Memory memory_;
  /**
   ...
   */
  @java.lang.Override
  public protoInJava.Memory getMemory() {
    return memory_ == null ? protoInJava.Memory.getDefaultInstance() : memory_;
  }
  /**
   * <code>.techschool.pcbook.Memory memory = 2;</code>
   */
  @java.lang.Override
  public protoInJava.MemoryOrBuilder getMemoryOrBuilder() {
    return getMemory();
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    if (driver_ != protoInJava.Storage.Driver.UNKNOWN.getNumber()) {
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof protoInJava.Storage)) {
      return super.equals(obj);
    }
    protoInJava.Storage other = (protoInJava.Storage) obj;
  ...
  public static protoInJava.Storage parseFrom(
  ...
  public static protoInJava.Storage parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static protoInJava.Storage parseFrom(
  ...
  public static protoInJava.Storage parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static protoInJava.Storage parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static protoInJava.Storage parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(protoInJava.Storage prototype) {
  ...
  public static final class Builder extends
    ...
    // Construct using protoInJava.Storage.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public protoInJava.Storage getDefaultInstanceForType() {
      return protoInJava.Storage.getDefaultInstance();
    }

    @java.lang.Override
    public protoInJava.Storage build() {
      protoInJava.Storage result = buildPartial();
    ...
    @java.lang.Override
    public protoInJava.Storage buildPartial() {
      protoInJava.Storage result = new protoInJava.Storage(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof protoInJava.Storage) {
        return mergeFrom((protoInJava.Storage)other);
      } else {
    ...
    public Builder mergeFrom(protoInJava.Storage other) {
      if (other == protoInJava.Storage.getDefaultInstance()) return this;
      if (other.driver_ != 0) {
     ...
     */
    @java.lang.Override
    public protoInJava.Storage.Driver getDriver() {
      @SuppressWarnings("deprecation")
      protoInJava.Storage.Driver result = protoInJava.Storage.Driver.valueOf(driver_);
      return result == null ? protoInJava.Storage.Driver.UNRECOGNIZED : result;
    }
     ...
     * @return This builder for chaining.
     */
    public Builder setDriver(protoInJava.Storage.Driver value) {
      if (value == null) {
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
        protoInJava.Memory, protoInJava.Memory.Builder, protoInJava.MemoryOrBuilder> memoryBuilder_;
    /**
     * <code>.techschool.pcbook.Memory memory = 2;</code>
     * @return Whether the memory field is set.
     */
     ...
     * <code>.techschool.pcbook.Memory memory = 2;</code>
     */
    public Builder setMemory(protoInJava.Memory value) {
      if (memoryBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     * <code>.techschool.pcbook.Memory memory = 2;</code>
     */
    public Builder mergeMemory(protoInJava.Memory value) {
      if (memoryBuilder_ == null) {
        if (memory_ != null) {
          memory_ =
            protoInJava.Memory.newBuilder(memory_).mergeFrom(value).buildPartial();
        } else {
          memory_ = value;
        }
        onChanged();
     ...
     * <code>.techschool.pcbook.Memory memory = 2;</code>
     */
    public protoInJava.Memory.Builder getMemoryBuilder() {
    ...
    public protoInJava.MemoryOrBuilder getMemoryOrBuilder() {
      if (memoryBuilder_ != null) {
        ...
        return memory_ == null ?
            protoInJava.Memory.getDefaultInstance() : memory_;
      }
    }
    /**
     * <code>.techschool.pcbook.Memory memory = 2;</code>
  ...
  private static final protoInJava.Storage DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new protoInJava.Storage();
  }

  public static protoInJava.Storage getDefaultInstance() {
