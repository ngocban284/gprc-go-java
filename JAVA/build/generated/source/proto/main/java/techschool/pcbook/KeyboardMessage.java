...
public final class KeyboardMessage {
  ...
  public interface KeyboardOrBuilder extends
     ...
     * @return The layout.
     */
    techschool.pcbook.KeyboardMessage.Keyboard.Layout getLayout();
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return techschool.pcbook.KeyboardMessage.internal_static_techschool_pcbook_Keyboard_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return techschool.pcbook.KeyboardMessage.internal_static_techschool_pcbook_Keyboard_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              techschool.pcbook.KeyboardMessage.Keyboard.class, techschool.pcbook.KeyboardMessage.Keyboard.Builder.class);
    }
    ...
    public enum Layout
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return techschool.pcbook.KeyboardMessage.Keyboard.getDescriptor().getEnumTypes().get(0);
      }
     ...
     * @return The layout.
     */
    @java.lang.Override public techschool.pcbook.KeyboardMessage.Keyboard.Layout getLayout() {
      @SuppressWarnings("deprecation")
      techschool.pcbook.KeyboardMessage.Keyboard.Layout result = techschool.pcbook.KeyboardMessage.Keyboard.Layout.valueOf(layout_);
      return result == null ? techschool.pcbook.KeyboardMessage.Keyboard.Layout.UNRECOGNIZED : result;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (layout_ != techschool.pcbook.KeyboardMessage.Keyboard.Layout.UNKNOWN.getNumber()) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof techschool.pcbook.KeyboardMessage.Keyboard)) {
        return super.equals(obj);
      }
      techschool.pcbook.KeyboardMessage.Keyboard other = (techschool.pcbook.KeyboardMessage.Keyboard) obj;
    ...
    public static techschool.pcbook.KeyboardMessage.Keyboard parseFrom(
    ...
    public static techschool.pcbook.KeyboardMessage.Keyboard parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static techschool.pcbook.KeyboardMessage.Keyboard parseFrom(
    ...
    public static techschool.pcbook.KeyboardMessage.Keyboard parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static techschool.pcbook.KeyboardMessage.Keyboard parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static techschool.pcbook.KeyboardMessage.Keyboard parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(techschool.pcbook.KeyboardMessage.Keyboard prototype) {
    ...
    public static final class Builder extends
        ...
        techschool.pcbook.KeyboardMessage.KeyboardOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return techschool.pcbook.KeyboardMessage.internal_static_techschool_pcbook_Keyboard_descriptor;
      }
      ...
      // Construct using techschool.pcbook.KeyboardMessage.Keyboard.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public techschool.pcbook.KeyboardMessage.Keyboard getDefaultInstanceForType() {
        return techschool.pcbook.KeyboardMessage.Keyboard.getDefaultInstance();
      }

      @java.lang.Override
      public techschool.pcbook.KeyboardMessage.Keyboard build() {
        techschool.pcbook.KeyboardMessage.Keyboard result = buildPartial();
      ...
      @java.lang.Override
      public techschool.pcbook.KeyboardMessage.Keyboard buildPartial() {
        techschool.pcbook.KeyboardMessage.Keyboard result = new techschool.pcbook.KeyboardMessage.Keyboard(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof techschool.pcbook.KeyboardMessage.Keyboard) {
          return mergeFrom((techschool.pcbook.KeyboardMessage.Keyboard)other);
        } else {
      ...
      public Builder mergeFrom(techschool.pcbook.KeyboardMessage.Keyboard other) {
        if (other == techschool.pcbook.KeyboardMessage.Keyboard.getDefaultInstance()) return this;
        if (other.layout_ != 0) {
       ...
       */
      @java.lang.Override
      public techschool.pcbook.KeyboardMessage.Keyboard.Layout getLayout() {
        @SuppressWarnings("deprecation")
        techschool.pcbook.KeyboardMessage.Keyboard.Layout result = techschool.pcbook.KeyboardMessage.Keyboard.Layout.valueOf(layout_);
        return result == null ? techschool.pcbook.KeyboardMessage.Keyboard.Layout.UNRECOGNIZED : result;
      }
       ...
       * @return This builder for chaining.
       */
      public Builder setLayout(techschool.pcbook.KeyboardMessage.Keyboard.Layout value) {
        if (value == null) {
    ...
    private static final techschool.pcbook.KeyboardMessage.Keyboard DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new techschool.pcbook.KeyboardMessage.Keyboard();
    }

    public static techschool.pcbook.KeyboardMessage.Keyboard getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\022\n\n\006QWERTZ\020\002\022\n\n\006AZERTY\020\003B\006Z\004.;pbb\006proto3"
    };
